...
public class GroceryItemActivity extends AppCompatActivity implements AddReviewDialog.AddReview {
    ...
    public void onAddReviewResult(Review review) {
        ...
        utils.increaseUserPoints(incomingItem, 3);
    ...
    private ImageView firstFilledStar, secondFilledStar, thirdFilledStar, forthFilledStar, fifthFilledStar;
    private ImageView firstEmptyStar, secondEmptyStar, thirdEmptyStar, forthEmptyStar, fifthEmptyStar;
    ...
    private void setViewsValues(){
        ...
        txtAvailability.setText(String.valueOf(incomingItem.getAvailableAmount()+" number(s) available"));
        Glide.with(this)
                .asBitmap()
        ...
        btnAddToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Toast.makeText(GroceryItemActivity.this, "cart Clicked", Toast.LENGTH_SHORT).show();
    ...
    /***
     * Responsible for setting the rate stars
     */
    private void handleStarsSituation(){
        ...
        forthEmptyStar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        fifthEmptyStar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        forthFilledStar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(checkIfRateHasChanged(4)){
                    updateDatabase(4);
        ...
        fifthFilledStar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(checkIfRateHasChanged(5)){
                    updateDatabase(5);
    ...
    private void changeUserPoint(int stars) {
        ...
        utils.increaseUserPoints(incomingItem, (stars-currentRate)*2);
    }

    /***
     * Responsible in changing the visibility of stars
     * @param newRate no of stars to view
     */
    private void changeVisibility(int newRate){
        ...
        switch(newRate){
            case 1:
                ...
                forthFilledStar.setVisibility(View.GONE);
                ...
                forthEmptyStar.setVisibility(View.VISIBLE);
            ...
            case 4:
                ...
                secondFilledStar.setVisibility(View.VISIBLE);
                thirdFilledStar.setVisibility(View.VISIBLE);
                forthFilledStar.setVisibility(View.VISIBLE);
                fifthFilledStar.setVisibility(View.GONE);

                firstEmptyStar.setVisibility(View.GONE);
                secondEmptyStar.setVisibility(View.GONE);
                thirdEmptyStar.setVisibility(View.GONE);
                forthEmptyStar.setVisibility(View.GONE);
                fifthEmptyStar.setVisibility(View.VISIBLE);
    ...
    private void updateDatabase(int newRate){
        Log.d(TAG, "updateDatabase: created");
    ...
    private void initViews(){
        ...
        forthFilledStar = (ImageView) findViewById(R.id.forthFilledStar);
        fifthFilledStar = (ImageView) findViewById(R.id.fifthFilledStar);
        ...
        forthEmptyStar = (ImageView) findViewById(R.id.forthEmptyStar);
        fifthEmptyStar = (ImageView) findViewById(R.id.fifthEmptyStar);
